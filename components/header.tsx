        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-4">
              ...
              <span className="hidden md:inline">Livraison rapide avec GoZem</span>
            </div>
            <div className="flex items-center gap-4">
              <Link href="/faq" className="hover:underline">
                Aide
              </Link>
              <Link href="/inscription?type=pharmacy" className="hover:underline">
                Devenir partenaire
              </Link>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <Link href="/" className="flex items-center gap-2">
            <img src="/Logo.jpg" alt="BoltPharma Logo" className="h-10 w-10 object-contain" />
            <div className="hidden md:block">
              <div className="text-xl font-bold text-primary">BoltPharma</div>
              <div className="text-xs text-muted-foreground">Votre santé, notre priorité</div>
            </div>
          </Link>

          {/* Search bar */}
          <form onSubmit={handleSearch} className="hidden flex-1 md:block md:max-w-xl">
